...
def performDetect(imagePath="data/testfile.jpg", thresh= 0.25, configPath = "./cfg/yolov4-ANPR.cfg", weightPath = "./backup/yolov4-ANPR.weights", metaPath= "./data/obj.data", showImage= True, makeImageOnly = False, initOnly= False):
    """
        ...
        try:
            ...
            for detection in detections:
                ...
                if label == "license_plate" :
                    cropped = image[yCoord : yCoord + yExtent, xCoord : xCoord + xEntent]
                    io.imshow(cropped)
                    io.show()
